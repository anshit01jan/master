...
Evidence note: when automation stabilization changes are present, review commentary should distinguish product defects from harness-only failures.
...
Use `agent-output/create-impl.md` as the implementation summary and `.github/codereview-checklist` as the mandatory checklist.

## Review Checklist (Mandatory)
Evaluate findings against these dimensions from `.github/codereview-checklist`:
...
## Execution Flow
1. Read `agent-output/create-impl.md` and `.github/codereview-checklist` before reviewing code.
