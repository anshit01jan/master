...
- Generated cases must stay traceable to requirements even if a later automation run only exercises a subset of them; do not shrink or rewrite test cases to match a narrower runnable scope.
